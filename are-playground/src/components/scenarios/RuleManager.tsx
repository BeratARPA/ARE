            ...
            return (
              <motion.div
                ...
                className={`rounded-lg border p-3 transition-colors ${
                  enabled ? 'border-white/8 bg-white/3' : 'border-white/3 bg-white/1'
                }`}
              >
                ...
                <div className="flex flex-wrap gap-1 mt-2">
                  <Badge color="rgba(92,124,250,0.15)">
                    <span className="text-primary-300">{t('panels.priority')}: {rule.priority}</span>
                  </Badge>
                  <Badge color="rgba(81,207,102,0.15)">
                    <span className="text-success">{t('panels.group')}: {rule.group}</span>
                  </Badge>
                  <Badge color="rgba(255,169,77,0.15)">
                    <span className="text-accent-400">{t('panels.matchMode')}: {rule.matchMode}</span>
                  </Badge>
                </div>
              </motion.div>
            );
